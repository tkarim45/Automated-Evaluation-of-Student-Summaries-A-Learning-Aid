function handleFile() {
    ...
    reader.onload = function () {
        ...
        xhr.open("POST", "/teachernotadhd/submit_summary", true);
        ...
        xhr.onreadystatechange = function () {
            if (xhr.readyState === 4) {
                if (xhr.status === 200) {
                    ...
                    window.location.href = "/teacherresultnotadhd?markdown_content=" + encodeURIComponent(markdownContent) + "&content_score=" + contentScore + "&wording_score=" + wordingScore;
                } else {
